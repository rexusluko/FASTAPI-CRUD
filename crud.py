...
def get_submenu(db: Session, menu_id : str,submenu_id: str):
    return db.query(models.SubMenu).filter(and_(models.SubMenu.id == submenu_id,models.SubMenu.menu_id ==menu_id)).first()
...
def update_submenu(db: Session, menu_id:str,submenu_id:str, new_submenu:schemas.SubMenuUpdate):
    ...
    db_submenu = db.query(models.SubMenu).filter(and_(models.SubMenu.id == submenu_id,models.SubMenu.menu_id ==menu_id)).first()
...
def update_dish(db: Session, submenu_id:str,dish_id: str, new_dish:schemas.DishUpdate):
    ...
    db_dish = db.query(models.Dish).filter(and_(models.Dish.id == dish_id,models.Dish.submenu_id == submenu_id)).first()
